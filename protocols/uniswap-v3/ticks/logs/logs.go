...
import (
	uniswapv3abi "github.com/defistate/defistate/protocols/uniswap-v3/abi" // Assumes this is where your ABI is located
...
var (
	...
	mintEvent = uniswapv3abi.UniswapV3ABI.Events["Mint"]
	burnEvent = uniswapv3abi.UniswapV3ABI.Events["Burn"]
)

// UniswapV3PoolsUpdatedInBlock parses a slice of logs and returns the pool addresses
// and a corresponding list of unique tick indexes that were updated via Mint or Burn events.
func UniswapV3PoolsUpdatedInBlock(logs []types.Log) (pools []common.Address, updatedTicks [][]int64, err error) {
