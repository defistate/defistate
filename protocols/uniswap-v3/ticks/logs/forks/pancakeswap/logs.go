...
import (
	"github.com/defistate/defistate/protocols/uniswap-v3/abi/forks/pancakeswap" // Assumes this is where your ABI is located
...
var (
	...
	mintEvent = pancakeswap.PancakeswapV3ABI.Events["Mint"]
	burnEvent = pancakeswap.PancakeswapV3ABI.Events["Burn"]
)

// PancakeswapV3PoolsUpdatedInBlock parses a slice of logs and returns the pool addresses
// and a corresponding list of unique tick indexes that were updated via Mint or Burn events.
func PancakeswapV3PoolsUpdatedInBlock(logs []types.Log) (pools []common.Address, updatedTicks [][]int64, err error) {
