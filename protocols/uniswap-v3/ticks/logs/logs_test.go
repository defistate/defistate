...
import (
	...
	"github.com/defistate/defistate/protocols/uniswap-v3/abi" // Assumes this is where your ABI is located
...
func TestUniswapV3PoolsUpdatedInBlock(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			gotPools, gotTicksByPool, gotErrs := UniswapV3PoolsUpdatedInBlock(tc.inputLogs)
