...
import (
	...
	stateops "github.com/defistate/defistate/streams/jsonrpc/stateops/chains/base"
...
// Config defines the required dependencies for the Base client.
type Config struct {
...
const (
	UniswapV2ProtocolID     = engine.ProtocolID("uniswap-v2-base-mainnet")
	UniswapV3ProtocolID     = engine.ProtocolID("uniswap-v3-base-mainnet")
	PancakeswapV3ProtocolID = engine.ProtocolID("pancakeswap-v3-base-mainnet")
)
